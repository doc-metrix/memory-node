...
(function() {
	...
	var	METRICS = require( './../docs/memory.json' );
	...
	*/
	...
	/**
	* METHOD: mget( filter )
	*	Returns metric documentation. If a metric name is provided as a filter, returns an individual metric's documentation. If no documentation exists, returns `null`. If a regular expression is provided, returns all documentation matching the filter. If no argument is provided, returns all metric documentation.
	*
